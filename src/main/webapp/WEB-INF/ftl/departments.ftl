...
<html>
                        ...
                        <#list deps as dep>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="clickbutton" style="display: none" id="cancel${dep.departmentid}" onclick="cancelDep(${dep.departmentid},'${dep.departmentname}')">取消</a>
    ...
    <script>
        function cancelDep(depid,depname){
        ...
        function editDep(depid) {
            ...
            if (cancelBtn.css('display') == 'none'){
                ...
                var chilren=ele.children('input');
