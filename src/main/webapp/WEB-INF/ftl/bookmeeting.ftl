                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            ...
                            <tr>
                                <td>预计开始时间：</td>
                                <td>
                                    <input type="date" id="startdate" name="starttime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})" />
                            ...
                            <tr>
                                <td>预计结束时间：</td>
                                <td>
                                    <input type="date" id="enddate" name="endtime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})" />
